						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<a href="fungsi/hapusMakanan.php?id_masakan=<?= urlencode($data['id_masakan']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus minuman ini?');">Hapus</a>
								</div>
							</td>
						</tr>
					<?php endwhile; ?>
