...
<?php foreach ($order as $detRow) : ?>
    <div class="modal fade" id="detailOrder_<?= $detRow['id_order'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
