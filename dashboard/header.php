...
<head>
  ...
  <!-- favicon -->
  <link rel="icon" type="image/png" href="assets/image/resto.jpg">
  <title>Resto Pulau Osi</title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <?php if ($level == "Admin"): ?>
            ...
            <div class="nav-item dropdown <?= $us ?><?= $m ?>">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="index.php?nomeja">Data Meja</a>
              </div>
            </div>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php endif; ?>
          <!-- Buat kondisi yang bisa melihat order hanya waiter -->
          <?php if ($_SESSION['level'] == "Waiter"): ?>
            <li class="nav-item dropdown">
              <a href="#" class="nav-link" data-toggle="modal" data-target=".bd-example-modal-xl">
                ...
                <table class="table table-striped">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <!-- tampilkan harga total per user -->
